...
class Contract extends DomainResource {
  ...
  get agent() {
    if (!isPresent(this[_values].agent)) {
      const klass = require('./ContractAgent');
  ...
  get signer() {
    if (!isPresent(this[_values].signer)) {
      const klass = require('./ContractSigner');
  ...
  get valuedItem() {
    if (!isPresent(this[_values].valuedItem)) {
      const klass = require('./ContractValuedItem');
  ...
  get friendly() {
    if (!isPresent(this[_values].friendly)) {
      const klass = require('./ContractFriendly');
  ...
  get legal() {
    if (!isPresent(this[_values].legal)) {
      const klass = require('./ContractLegal');
  ...
  get rule() {
    if (!isPresent(this[_values].rule)) {
      const klass = require('./ContractRule');
