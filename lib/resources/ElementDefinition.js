...
class ElementDefinition extends Element {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ElementDefinition ||
  ...
  get _representation() {
    if (!isPresent(this[_values]._representation)) {
      const klass = require('./Element');
  ...
  get slicing() {
    if (!isPresent(this[_values].slicing)) {
      const klass = require('./ElementDefinitionSlicing');
  ...
  get _short() {
    if (!isPresent(this[_values]._short)) {
      const klass = require('./Element');
  ...
  get base() {
    if (!isPresent(this[_values].base)) {
      const klass = require('./ElementDefinitionBase');
  ...
  get _contentReference() {
    if (!isPresent(this[_values]._contentReference)) {
      const klass = require('./Element');
  ...
  get type() {
    if (!isPresent(this[_values].type)) {
      const klass = require('./ElementDefinitionType');
  ...
  get _defaultValueBoolean() {
    if (!isPresent(this[_values]._defaultValueBoolean)) {
      const klass = require('./Element');
  ...
  get _defaultValueInteger() {
    if (!isPresent(this[_values]._defaultValueInteger)) {
      const klass = require('./Element');
  ...
  get _defaultValueDecimal() {
    if (!isPresent(this[_values]._defaultValueDecimal)) {
      const klass = require('./Element');
  ...
  get _defaultValueBase64Binary() {
    if (!isPresent(this[_values]._defaultValueBase64Binary)) {
      const klass = require('./Element');
  ...
  get _defaultValueInstant() {
    if (!isPresent(this[_values]._defaultValueInstant)) {
      const klass = require('./Element');
  ...
  get _defaultValueString() {
    if (!isPresent(this[_values]._defaultValueString)) {
      const klass = require('./Element');
  ...
  get _defaultValueUri() {
    if (!isPresent(this[_values]._defaultValueUri)) {
      const klass = require('./Element');
  ...
  get _defaultValueDate() {
    if (!isPresent(this[_values]._defaultValueDate)) {
      const klass = require('./Element');
  ...
  get _defaultValueDateTime() {
    if (!isPresent(this[_values]._defaultValueDateTime)) {
      const klass = require('./Element');
  ...
  get _defaultValueTime() {
    if (!isPresent(this[_values]._defaultValueTime)) {
      const klass = require('./Element');
  ...
  get _defaultValueCode() {
    if (!isPresent(this[_values]._defaultValueCode)) {
      const klass = require('./Element');
  ...
  get _defaultValueOid() {
    if (!isPresent(this[_values]._defaultValueOid)) {
      const klass = require('./Element');
  ...
  get _defaultValueUuid() {
    if (!isPresent(this[_values]._defaultValueUuid)) {
      const klass = require('./Element');
  ...
  get _defaultValueId() {
    if (!isPresent(this[_values]._defaultValueId)) {
      const klass = require('./Element');
  ...
  get _defaultValueUnsignedInt() {
    if (!isPresent(this[_values]._defaultValueUnsignedInt)) {
      const klass = require('./Element');
  ...
  get _defaultValuePositiveInt() {
    if (!isPresent(this[_values]._defaultValuePositiveInt)) {
      const klass = require('./Element');
  ...
  get _defaultValueMarkdown() {
    if (!isPresent(this[_values]._defaultValueMarkdown)) {
      const klass = require('./Element');
  ...
  get defaultValueElement() {
    if (!isPresent(this[_values].defaultValueElement)) {
      const klass = require('./Element');
  ...
  get defaultValueExtension() {
    if (!isPresent(this[_values].defaultValueExtension)) {
  ...
  get defaultValueBackboneElement() {
    if (!isPresent(this[_values].defaultValueBackboneElement)) {
  ...
  get defaultValueNarrative() {
    if (!isPresent(this[_values].defaultValueNarrative)) {
  ...
  get defaultValueAnnotation() {
    if (!isPresent(this[_values].defaultValueAnnotation)) {
  ...
  get defaultValueAttachment() {
    if (!isPresent(this[_values].defaultValueAttachment)) {
  ...
  get defaultValueIdentifier() {
    if (!isPresent(this[_values].defaultValueIdentifier)) {
  ...
  get defaultValueCodeableConcept() {
    if (!isPresent(this[_values].defaultValueCodeableConcept)) {
  ...
  get defaultValueCoding() {
    if (!isPresent(this[_values].defaultValueCoding)) {
      const klass = require('./Coding');
  ...
  get defaultValueQuantity() {
    if (!isPresent(this[_values].defaultValueQuantity)) {
  ...
  get defaultValueDuration() {
    if (!isPresent(this[_values].defaultValueDuration)) {
  ...
  get defaultValueSimpleQuantity() {
    if (!isPresent(this[_values].defaultValueSimpleQuantity)) {
      const klass = require('./Quantity');
  ...
  get defaultValueDistance() {
    if (!isPresent(this[_values].defaultValueDistance)) {
  ...
  get defaultValueCount() {
    if (!isPresent(this[_values].defaultValueCount)) {
  ...
  get defaultValueMoney() {
    if (!isPresent(this[_values].defaultValueMoney)) {
  ...
  get defaultValueAge() {
    if (!isPresent(this[_values].defaultValueAge)) {
  ...
  get defaultValueRange() {
    if (!isPresent(this[_values].defaultValueRange)) {
  ...
  get defaultValuePeriod() {
    if (!isPresent(this[_values].defaultValuePeriod)) {
  ...
  get defaultValueRatio() {
    if (!isPresent(this[_values].defaultValueRatio)) {
  ...
  get defaultValueReference() {
    if (!isPresent(this[_values].defaultValueReference)) {
  ...
  get defaultValueSampledData() {
    if (!isPresent(this[_values].defaultValueSampledData)) {
  ...
  get defaultValueSignature() {
    if (!isPresent(this[_values].defaultValueSignature)) {
  ...
  get defaultValueHumanName() {
    if (!isPresent(this[_values].defaultValueHumanName)) {
  ...
  get defaultValueAddress() {
    if (!isPresent(this[_values].defaultValueAddress)) {
  ...
  get defaultValueContactPoint() {
    if (!isPresent(this[_values].defaultValueContactPoint)) {
  ...
  get defaultValueTiming() {
    if (!isPresent(this[_values].defaultValueTiming)) {
  ...
  get defaultValueMeta() {
    if (!isPresent(this[_values].defaultValueMeta)) {
  ...
  get defaultValueElementDefinition() {
    if (!isPresent(this[_values].defaultValueElementDefinition)) {
  ...
  get defaultValueContactDetail() {
    if (!isPresent(this[_values].defaultValueContactDetail)) {
  ...
  get defaultValueContributor() {
    if (!isPresent(this[_values].defaultValueContributor)) {
  ...
  get defaultValueDosage() {
    if (!isPresent(this[_values].defaultValueDosage)) {
  ...
  get defaultValueRelatedArtifact() {
    if (!isPresent(this[_values].defaultValueRelatedArtifact)) {
  ...
  get defaultValueUsageContext() {
    if (!isPresent(this[_values].defaultValueUsageContext)) {
  ...
  get defaultValueDataRequirement() {
    if (!isPresent(this[_values].defaultValueDataRequirement)) {
  ...
  get defaultValueParameterDefinition() {
    if (!isPresent(this[_values].defaultValueParameterDefinition)) {
  ...
  get defaultValueTriggerDefinition() {
    if (!isPresent(this[_values].defaultValueTriggerDefinition)) {
  ...
  get _meaningWhenMissing() {
    if (!isPresent(this[_values]._meaningWhenMissing)) {
      const klass = require('./Element');
  ...
  get _orderMeaning() {
    if (!isPresent(this[_values]._orderMeaning)) {
      const klass = require('./Element');
  ...
  get _fixedBoolean() {
    if (!isPresent(this[_values]._fixedBoolean)) {
      const klass = require('./Element');
  ...
  get _fixedInteger() {
    if (!isPresent(this[_values]._fixedInteger)) {
      const klass = require('./Element');
  ...
  get _fixedDecimal() {
    if (!isPresent(this[_values]._fixedDecimal)) {
      const klass = require('./Element');
  ...
  get _fixedBase64Binary() {
    if (!isPresent(this[_values]._fixedBase64Binary)) {
      const klass = require('./Element');
  ...
  get _fixedInstant() {
    if (!isPresent(this[_values]._fixedInstant)) {
      const klass = require('./Element');
  ...
  get _fixedString() {
    if (!isPresent(this[_values]._fixedString)) {
      const klass = require('./Element');
  ...
  get _fixedUri() {
    if (!isPresent(this[_values]._fixedUri)) {
      const klass = require('./Element');
  ...
  get _fixedDate() {
    if (!isPresent(this[_values]._fixedDate)) {
      const klass = require('./Element');
  ...
  get _fixedDateTime() {
    if (!isPresent(this[_values]._fixedDateTime)) {
      const klass = require('./Element');
  ...
  get _fixedTime() {
    if (!isPresent(this[_values]._fixedTime)) {
      const klass = require('./Element');
  ...
  get _fixedCode() {
    if (!isPresent(this[_values]._fixedCode)) {
      const klass = require('./Element');
  ...
  get _fixedOid() {
    if (!isPresent(this[_values]._fixedOid)) {
      const klass = require('./Element');
  ...
  get _fixedUuid() {
    if (!isPresent(this[_values]._fixedUuid)) {
      const klass = require('./Element');
  ...
  get _fixedId() {
    if (!isPresent(this[_values]._fixedId)) {
      const klass = require('./Element');
  ...
  get _fixedUnsignedInt() {
    if (!isPresent(this[_values]._fixedUnsignedInt)) {
      const klass = require('./Element');
  ...
  get _fixedPositiveInt() {
    if (!isPresent(this[_values]._fixedPositiveInt)) {
      const klass = require('./Element');
  ...
  get _fixedMarkdown() {
    if (!isPresent(this[_values]._fixedMarkdown)) {
      const klass = require('./Element');
  ...
  get fixedElement() {
    if (!isPresent(this[_values].fixedElement)) {
      const klass = require('./Element');
  ...
  get fixedExtension() {
    if (!isPresent(this[_values].fixedExtension)) {
      const klass = require('./Extension');
  ...
  get fixedBackboneElement() {
    if (!isPresent(this[_values].fixedBackboneElement)) {
      const klass = require('./BackboneElement');
  ...
  get fixedNarrative() {
    if (!isPresent(this[_values].fixedNarrative)) {
      const klass = require('./Narrative');
  ...
  get fixedAnnotation() {
    if (!isPresent(this[_values].fixedAnnotation)) {
      const klass = require('./Annotation');
  ...
  get fixedAttachment() {
    if (!isPresent(this[_values].fixedAttachment)) {
      const klass = require('./Attachment');
  ...
  get fixedIdentifier() {
    if (!isPresent(this[_values].fixedIdentifier)) {
      const klass = require('./Identifier');
  ...
  get fixedCodeableConcept() {
    if (!isPresent(this[_values].fixedCodeableConcept)) {
      const klass = require('./CodeableConcept');
  ...
  get fixedCoding() {
    if (!isPresent(this[_values].fixedCoding)) {
      const klass = require('./Coding');
  ...
  get fixedQuantity() {
    if (!isPresent(this[_values].fixedQuantity)) {
      const klass = require('./Quantity');
  ...
  get fixedDuration() {
    if (!isPresent(this[_values].fixedDuration)) {
      const klass = require('./Duration');
  ...
  get fixedSimpleQuantity() {
    if (!isPresent(this[_values].fixedSimpleQuantity)) {
      const klass = require('./Quantity');
  ...
  get fixedDistance() {
    if (!isPresent(this[_values].fixedDistance)) {
      const klass = require('./Distance');
  ...
  get fixedCount() {
    if (!isPresent(this[_values].fixedCount)) {
      const klass = require('./Count');
  ...
  get fixedMoney() {
    if (!isPresent(this[_values].fixedMoney)) {
      const klass = require('./Money');
  ...
  get fixedAge() {
    if (!isPresent(this[_values].fixedAge)) {
      const klass = require('./Age');
  ...
  get fixedRange() {
    if (!isPresent(this[_values].fixedRange)) {
      const klass = require('./Range');
  ...
  get fixedPeriod() {
    if (!isPresent(this[_values].fixedPeriod)) {
      const klass = require('./Period');
  ...
  get fixedRatio() {
    if (!isPresent(this[_values].fixedRatio)) {
      const klass = require('./Ratio');
  ...
  get fixedReference() {
    if (!isPresent(this[_values].fixedReference)) {
      const klass = require('./Reference');
  ...
  get fixedSampledData() {
    if (!isPresent(this[_values].fixedSampledData)) {
      const klass = require('./SampledData');
  ...
  get fixedSignature() {
    if (!isPresent(this[_values].fixedSignature)) {
      const klass = require('./Signature');
  ...
  get fixedHumanName() {
    if (!isPresent(this[_values].fixedHumanName)) {
      const klass = require('./HumanName');
  ...
  get fixedAddress() {
    if (!isPresent(this[_values].fixedAddress)) {
      const klass = require('./Address');
  ...
  get fixedContactPoint() {
    if (!isPresent(this[_values].fixedContactPoint)) {
      const klass = require('./ContactPoint');
  ...
  get fixedTiming() {
    if (!isPresent(this[_values].fixedTiming)) {
      const klass = require('./Timing');
  ...
  get fixedMeta() {
    if (!isPresent(this[_values].fixedMeta)) {
      const klass = require('./Meta');
  ...
  get fixedElementDefinition() {
    if (!isPresent(this[_values].fixedElementDefinition)) {
      const klass = require('./ElementDefinition');
  ...
  get fixedContactDetail() {
    if (!isPresent(this[_values].fixedContactDetail)) {
      const klass = require('./ContactDetail');
  ...
  get fixedContributor() {
    if (!isPresent(this[_values].fixedContributor)) {
      const klass = require('./Contributor');
  ...
  get fixedDosage() {
    if (!isPresent(this[_values].fixedDosage)) {
      const klass = require('./Dosage');
  ...
  get fixedRelatedArtifact() {
    if (!isPresent(this[_values].fixedRelatedArtifact)) {
      const klass = require('./RelatedArtifact');
  ...
  get fixedUsageContext() {
    if (!isPresent(this[_values].fixedUsageContext)) {
      const klass = require('./UsageContext');
  ...
  get fixedDataRequirement() {
    if (!isPresent(this[_values].fixedDataRequirement)) {
      const klass = require('./DataRequirement');
  ...
  get fixedParameterDefinition() {
    if (!isPresent(this[_values].fixedParameterDefinition)) {
      const klass = require('./ParameterDefinition');
  ...
  get fixedTriggerDefinition() {
    if (!isPresent(this[_values].fixedTriggerDefinition)) {
      const klass = require('./TriggerDefinition');
  ...
  get _patternBoolean() {
    if (!isPresent(this[_values]._patternBoolean)) {
      const klass = require('./Element');
  ...
  get _patternInteger() {
    if (!isPresent(this[_values]._patternInteger)) {
      const klass = require('./Element');
  ...
  get _patternDecimal() {
    if (!isPresent(this[_values]._patternDecimal)) {
      const klass = require('./Element');
  ...
  get _patternBase64Binary() {
    if (!isPresent(this[_values]._patternBase64Binary)) {
      const klass = require('./Element');
  ...
  get _patternInstant() {
    if (!isPresent(this[_values]._patternInstant)) {
      const klass = require('./Element');
  ...
  get _patternString() {
    if (!isPresent(this[_values]._patternString)) {
      const klass = require('./Element');
  ...
  get _patternUri() {
    if (!isPresent(this[_values]._patternUri)) {
      const klass = require('./Element');
  ...
  get _patternDate() {
    if (!isPresent(this[_values]._patternDate)) {
      const klass = require('./Element');
  ...
  get _patternDateTime() {
    if (!isPresent(this[_values]._patternDateTime)) {
      const klass = require('./Element');
  ...
  get _patternTime() {
    if (!isPresent(this[_values]._patternTime)) {
      const klass = require('./Element');
  ...
  get _patternCode() {
    if (!isPresent(this[_values]._patternCode)) {
      const klass = require('./Element');
  ...
  get _patternOid() {
    if (!isPresent(this[_values]._patternOid)) {
      const klass = require('./Element');
  ...
  get _patternUuid() {
    if (!isPresent(this[_values]._patternUuid)) {
      const klass = require('./Element');
  ...
  get _patternId() {
    if (!isPresent(this[_values]._patternId)) {
      const klass = require('./Element');
  ...
  get _patternUnsignedInt() {
    if (!isPresent(this[_values]._patternUnsignedInt)) {
      const klass = require('./Element');
  ...
  get _patternPositiveInt() {
    if (!isPresent(this[_values]._patternPositiveInt)) {
      const klass = require('./Element');
  ...
  get _patternMarkdown() {
    if (!isPresent(this[_values]._patternMarkdown)) {
      const klass = require('./Element');
  ...
  get patternElement() {
    if (!isPresent(this[_values].patternElement)) {
      const klass = require('./Element');
  ...
  get patternExtension() {
    if (!isPresent(this[_values].patternExtension)) {
      const klass = require('./Extension');
  ...
  get patternBackboneElement() {
    if (!isPresent(this[_values].patternBackboneElement)) {
      const klass = require('./BackboneElement');
  ...
  get patternNarrative() {
    if (!isPresent(this[_values].patternNarrative)) {
      const klass = require('./Narrative');
  ...
  get patternAnnotation() {
    if (!isPresent(this[_values].patternAnnotation)) {
      const klass = require('./Annotation');
  ...
  get patternAttachment() {
    if (!isPresent(this[_values].patternAttachment)) {
      const klass = require('./Attachment');
  ...
  get patternIdentifier() {
    if (!isPresent(this[_values].patternIdentifier)) {
      const klass = require('./Identifier');
  ...
  get patternCodeableConcept() {
    if (!isPresent(this[_values].patternCodeableConcept)) {
      const klass = require('./CodeableConcept');
  ...
  get patternCoding() {
    if (!isPresent(this[_values].patternCoding)) {
      const klass = require('./Coding');
  ...
  get patternQuantity() {
    if (!isPresent(this[_values].patternQuantity)) {
      const klass = require('./Quantity');
  ...
  get patternDuration() {
    if (!isPresent(this[_values].patternDuration)) {
      const klass = require('./Duration');
  ...
  get patternSimpleQuantity() {
    if (!isPresent(this[_values].patternSimpleQuantity)) {
      const klass = require('./Quantity');
  ...
  get patternDistance() {
    if (!isPresent(this[_values].patternDistance)) {
      const klass = require('./Distance');
  ...
  get patternCount() {
    if (!isPresent(this[_values].patternCount)) {
      const klass = require('./Count');
  ...
  get patternMoney() {
    if (!isPresent(this[_values].patternMoney)) {
      const klass = require('./Money');
  ...
  get patternAge() {
    if (!isPresent(this[_values].patternAge)) {
      const klass = require('./Age');
  ...
  get patternRange() {
    if (!isPresent(this[_values].patternRange)) {
      const klass = require('./Range');
  ...
  get patternPeriod() {
    if (!isPresent(this[_values].patternPeriod)) {
      const klass = require('./Period');
  ...
  get patternRatio() {
    if (!isPresent(this[_values].patternRatio)) {
      const klass = require('./Ratio');
  ...
  get patternReference() {
    if (!isPresent(this[_values].patternReference)) {
      const klass = require('./Reference');
  ...
  get patternSampledData() {
    if (!isPresent(this[_values].patternSampledData)) {
      const klass = require('./SampledData');
  ...
  get patternSignature() {
    if (!isPresent(this[_values].patternSignature)) {
      const klass = require('./Signature');
  ...
  get patternHumanName() {
    if (!isPresent(this[_values].patternHumanName)) {
      const klass = require('./HumanName');
  ...
  get patternAddress() {
    if (!isPresent(this[_values].patternAddress)) {
      const klass = require('./Address');
  ...
  get patternContactPoint() {
    if (!isPresent(this[_values].patternContactPoint)) {
      const klass = require('./ContactPoint');
  ...
  get patternTiming() {
    if (!isPresent(this[_values].patternTiming)) {
      const klass = require('./Timing');
  ...
  get patternMeta() {
    if (!isPresent(this[_values].patternMeta)) {
      const klass = require('./Meta');
  ...
  get patternElementDefinition() {
    if (!isPresent(this[_values].patternElementDefinition)) {
      const klass = require('./ElementDefinition');
  ...
  get patternContactDetail() {
    if (!isPresent(this[_values].patternContactDetail)) {
      const klass = require('./ContactDetail');
  ...
  get patternContributor() {
    if (!isPresent(this[_values].patternContributor)) {
      const klass = require('./Contributor');
  ...
  get patternDosage() {
    if (!isPresent(this[_values].patternDosage)) {
      const klass = require('./Dosage');
  ...
  get patternRelatedArtifact() {
    if (!isPresent(this[_values].patternRelatedArtifact)) {
      const klass = require('./RelatedArtifact');
  ...
  get patternUsageContext() {
    if (!isPresent(this[_values].patternUsageContext)) {
      const klass = require('./UsageContext');
  ...
  get patternDataRequirement() {
    if (!isPresent(this[_values].patternDataRequirement)) {
      const klass = require('./DataRequirement');
  ...
  get patternParameterDefinition() {
    if (!isPresent(this[_values].patternParameterDefinition)) {
      const klass = require('./ParameterDefinition');
  ...
  get patternTriggerDefinition() {
    if (!isPresent(this[_values].patternTriggerDefinition)) {
      const klass = require('./TriggerDefinition');
  ...
  get example() {
    if (!isPresent(this[_values].example)) {
      const klass = require('./ElementDefinitionExample');
  ...
  get _minValueDate() {
    if (!isPresent(this[_values]._minValueDate)) {
      const klass = require('./Element');
  ...
  get _minValueDateTime() {
    if (!isPresent(this[_values]._minValueDateTime)) {
      const klass = require('./Element');
  ...
  get _minValueInstant() {
    if (!isPresent(this[_values]._minValueInstant)) {
      const klass = require('./Element');
  ...
  get _minValueTime() {
    if (!isPresent(this[_values]._minValueTime)) {
      const klass = require('./Element');
  ...
  get _minValueDecimal() {
    if (!isPresent(this[_values]._minValueDecimal)) {
      const klass = require('./Element');
  ...
  get _minValueInteger() {
    if (!isPresent(this[_values]._minValueInteger)) {
      const klass = require('./Element');
  ...
  get _minValuePositiveInt() {
    if (!isPresent(this[_values]._minValuePositiveInt)) {
      const klass = require('./Element');
  ...
  get _minValueUnsignedInt() {
    if (!isPresent(this[_values]._minValueUnsignedInt)) {
      const klass = require('./Element');
  ...
  get minValueQuantity() {
    if (!isPresent(this[_values].minValueQuantity)) {
      const klass = require('./Quantity');
  ...
  get _maxValueDate() {
    if (!isPresent(this[_values]._maxValueDate)) {
      const klass = require('./Element');
  ...
  get _maxValueDateTime() {
    if (!isPresent(this[_values]._maxValueDateTime)) {
      const klass = require('./Element');
  ...
  get _maxValueInstant() {
    if (!isPresent(this[_values]._maxValueInstant)) {
      const klass = require('./Element');
  ...
  get _maxValueTime() {
    if (!isPresent(this[_values]._maxValueTime)) {
      const klass = require('./Element');
  ...
  get _maxValueDecimal() {
    if (!isPresent(this[_values]._maxValueDecimal)) {
      const klass = require('./Element');
  ...
  get _maxValueInteger() {
    if (!isPresent(this[_values]._maxValueInteger)) {
      const klass = require('./Element');
  ...
  get _maxValuePositiveInt() {
    if (!isPresent(this[_values]._maxValuePositiveInt)) {
      const klass = require('./Element');
  ...
  get _maxValueUnsignedInt() {
    if (!isPresent(this[_values]._maxValueUnsignedInt)) {
      const klass = require('./Element');
  ...
  get maxValueQuantity() {
    if (!isPresent(this[_values].maxValueQuantity)) {
      const klass = require('./Quantity');
  ...
  get _condition() {
    if (!isPresent(this[_values]._condition)) {
      const klass = require('./Element');
  ...
  get constraint() {
    if (!isPresent(this[_values].constraint)) {
      const klass = require('./ElementDefinitionConstraint');
  ...
  get _isModifier() {
    if (!isPresent(this[_values]._isModifier)) {
      const klass = require('./Element');
  ...
  get _isSummary() {
    if (!isPresent(this[_values]._isSummary)) {
      const klass = require('./Element');
  ...
  get binding() {
    if (!isPresent(this[_values].binding)) {
      const klass = require('./ElementDefinitionBinding');
  ...
  get mapping() {
    if (!isPresent(this[_values].mapping)) {
      const klass = require('./ElementDefinitionMapping');
