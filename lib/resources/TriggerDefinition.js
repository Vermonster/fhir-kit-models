...
class TriggerDefinition extends Element {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof TriggerDefinition ||
  ...
  get _eventName() {
    if (!isPresent(this[_values]._eventName)) {
      const klass = require('./Element');
  ...
  get eventTimingTiming() {
    if (!isPresent(this[_values].eventTimingTiming)) {
  ...
  get eventTimingReference() {
    if (!isPresent(this[_values].eventTimingReference)) {
  ...
  get _eventTimingDate() {
    if (!isPresent(this[_values]._eventTimingDate)) {
      const klass = require('./Element');
  ...
  get _eventTimingDateTime() {
    if (!isPresent(this[_values]._eventTimingDateTime)) {
      const klass = require('./Element');
  ...
  get eventData() {
    if (!isPresent(this[_values].eventData)) {
