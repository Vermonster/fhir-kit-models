...
class ParametersParameter extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ParametersParameter || values instanceof BackboneElement) {
  ...
  get _valueBase64Binary() {
    if (!isPresent(this[_values]._valueBase64Binary)) {
      const klass = require('./Element');
  ...
  get _valueInstant() {
    if (!isPresent(this[_values]._valueInstant)) {
      const klass = require('./Element');
  ...
  get _valueOid() {
    if (!isPresent(this[_values]._valueOid)) {
      const klass = require('./Element');
  ...
  get _valueUuid() {
    if (!isPresent(this[_values]._valueUuid)) {
      const klass = require('./Element');
  ...
  get _valueId() {
    if (!isPresent(this[_values]._valueId)) {
      const klass = require('./Element');
  ...
  get _valueUnsignedInt() {
    if (!isPresent(this[_values]._valueUnsignedInt)) {
      const klass = require('./Element');
  ...
  get _valuePositiveInt() {
    if (!isPresent(this[_values]._valuePositiveInt)) {
      const klass = require('./Element');
  ...
  get _valueMarkdown() {
    if (!isPresent(this[_values]._valueMarkdown)) {
      const klass = require('./Element');
  ...
  get valueElement() {
    if (!isPresent(this[_values].valueElement)) {
      const klass = require('./Element');
  ...
  get valueExtension() {
    if (!isPresent(this[_values].valueExtension)) {
  ...
  get valueBackboneElement() {
    if (!isPresent(this[_values].valueBackboneElement)) {
  ...
  get valueNarrative() {
    if (!isPresent(this[_values].valueNarrative)) {
  ...
  get valueAnnotation() {
    if (!isPresent(this[_values].valueAnnotation)) {
  ...
  get valueIdentifier() {
    if (!isPresent(this[_values].valueIdentifier)) {
  ...
  get valueSimpleQuantity() {
    if (!isPresent(this[_values].valueSimpleQuantity)) {
      const klass = require('./Quantity');
  ...
  get valueDistance() {
    if (!isPresent(this[_values].valueDistance)) {
  ...
  get valueCount() {
    if (!isPresent(this[_values].valueCount)) {
  ...
  get valueMoney() {
    if (!isPresent(this[_values].valueMoney)) {
  ...
  get valueAge() {
    if (!isPresent(this[_values].valueAge)) {
  ...
  get valueSignature() {
    if (!isPresent(this[_values].valueSignature)) {
  ...
  get valueHumanName() {
    if (!isPresent(this[_values].valueHumanName)) {
  ...
  get valueAddress() {
    if (!isPresent(this[_values].valueAddress)) {
  ...
  get valueContactPoint() {
    if (!isPresent(this[_values].valueContactPoint)) {
  ...
  get valueTiming() {
    if (!isPresent(this[_values].valueTiming)) {
  ...
  get valueMeta() {
    if (!isPresent(this[_values].valueMeta)) {
  ...
  get valueElementDefinition() {
    if (!isPresent(this[_values].valueElementDefinition)) {
  ...
  get valueContactDetail() {
    if (!isPresent(this[_values].valueContactDetail)) {
  ...
  get valueContributor() {
    if (!isPresent(this[_values].valueContributor)) {
  ...
  get valueDosage() {
    if (!isPresent(this[_values].valueDosage)) {
  ...
  get valueRelatedArtifact() {
    if (!isPresent(this[_values].valueRelatedArtifact)) {
  ...
  get valueUsageContext() {
    if (!isPresent(this[_values].valueUsageContext)) {
  ...
  get valueDataRequirement() {
    if (!isPresent(this[_values].valueDataRequirement)) {
  ...
  get valueParameterDefinition() {
    if (!isPresent(this[_values].valueParameterDefinition)) {
  ...
  get valueTriggerDefinition() {
    if (!isPresent(this[_values].valueTriggerDefinition)) {
  ...
  get part() {
    if (!isPresent(this[_values].part)) {
      const klass = require('./ParametersParameter');
