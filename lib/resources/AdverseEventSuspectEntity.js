...
class AdverseEventSuspectEntity extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof AdverseEventSuspectEntity || values instanceof BackboneElement) {
  ...
  get _causality() {
    if (!isPresent(this[_values]._causality)) {
  ...
  get causalityAssessment() {
    if (!isPresent(this[_values].causalityAssessment)) {
  ...
  get _causalityProductRelatedness() {
    if (!isPresent(this[_values]._causalityProductRelatedness)) {
      const klass = require('./Element');
  ...
  get causalityMethod() {
    if (!isPresent(this[_values].causalityMethod)) {
      const klass = require('./CodeableConcept');
  ...
  get causalityAuthor() {
    if (!isPresent(this[_values].causalityAuthor)) {
      const klass = require('./Reference');
  ...
  get causalityResult() {
    if (!isPresent(this[_values].causalityResult)) {
      const klass = require('./CodeableConcept');
