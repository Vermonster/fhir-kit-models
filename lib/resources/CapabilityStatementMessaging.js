...
class CapabilityStatementMessaging extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof CapabilityStatementMessaging || values instanceof BackboneElement) {
  ...
  get endpoint() {
    if (!isPresent(this[_values].endpoint)) {
      const klass = require('./CapabilityStatementEndpoint');
  ...
  get supportedMessage() {
    if (!isPresent(this[_values].supportedMessage)) {
      const klass = require('./CapabilityStatementSupportedMessage');
  ...
  get event() {
    if (!isPresent(this[_values].event)) {
      const klass = require('./CapabilityStatementEvent');
