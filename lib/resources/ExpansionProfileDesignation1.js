...
class ExpansionProfileDesignation1 extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ExpansionProfileDesignation1 || values instanceof BackboneElement) {
...
module.exports = ExpansionProfileDesignation1;
