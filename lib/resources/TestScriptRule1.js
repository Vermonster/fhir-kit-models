...
class TestScriptRule1 extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof TestScriptRule1 || values instanceof BackboneElement) {
  ...
  get param() {
    if (!isPresent(this[_values].param)) {
      const klass = require('./TestScriptParam1');
...
module.exports = TestScriptRule1;
