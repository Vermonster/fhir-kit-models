...
class TimingRepeat extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof TimingRepeat || values instanceof BackboneElement) {
  ...
  get boundsDuration() {
    if (!isPresent(this[_values].boundsDuration)) {
  ...
  get boundsRange() {
    if (!isPresent(this[_values].boundsRange)) {
  ...
  get boundsPeriod() {
    if (!isPresent(this[_values].boundsPeriod)) {
  ...
  get _countMax() {
    if (!isPresent(this[_values]._countMax)) {
      const klass = require('./Element');
  ...
  get _durationMax() {
    if (!isPresent(this[_values]._durationMax)) {
      const klass = require('./Element');
  ...
  get _durationUnit() {
    if (!isPresent(this[_values]._durationUnit)) {
      const klass = require('./Element');
  ...
  get _frequency() {
    if (!isPresent(this[_values]._frequency)) {
      const klass = require('./Element');
  ...
  get _frequencyMax() {
    if (!isPresent(this[_values]._frequencyMax)) {
      const klass = require('./Element');
  ...
  get _periodMax() {
    if (!isPresent(this[_values]._periodMax)) {
      const klass = require('./Element');
  ...
  get _periodUnit() {
    if (!isPresent(this[_values]._periodUnit)) {
      const klass = require('./Element');
  ...
  get _dayOfWeek() {
    if (!isPresent(this[_values]._dayOfWeek)) {
      const klass = require('./Element');
  ...
  get _timeOfDay() {
    if (!isPresent(this[_values]._timeOfDay)) {
      const klass = require('./Element');
