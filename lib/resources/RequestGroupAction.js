...
class RequestGroupAction extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof RequestGroupAction || values instanceof BackboneElement) {
  ...
  get condition() {
    if (!isPresent(this[_values].condition)) {
      const klass = require('./RequestGroupCondition');
  ...
  get relatedAction() {
    if (!isPresent(this[_values].relatedAction)) {
      const klass = require('./RequestGroupRelatedAction');
  ...
  get action() {
    if (!isPresent(this[_values].action)) {
      const klass = require('./RequestGroupAction');
