...
class EligibilityResponseFinancial extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof EligibilityResponseFinancial || values instanceof BackboneElement) {
...
module.exports = EligibilityResponseFinancial;
