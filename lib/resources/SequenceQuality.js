...
class SequenceQuality extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof SequenceQuality || values instanceof BackboneElement) {
  ...
  get standardSequence() {
    if (!isPresent(this[_values].standardSequence)) {
  ...
  get score() {
    if (!isPresent(this[_values].score)) {
  ...
  get _truthTP() {
    if (!isPresent(this[_values]._truthTP)) {
      const klass = require('./Element');
  ...
  get _queryTP() {
    if (!isPresent(this[_values]._queryTP)) {
      const klass = require('./Element');
  ...
  get _truthFN() {
    if (!isPresent(this[_values]._truthFN)) {
      const klass = require('./Element');
  ...
  get _queryFP() {
    if (!isPresent(this[_values]._queryFP)) {
      const klass = require('./Element');
  ...
  get _gtFP() {
    if (!isPresent(this[_values]._gtFP)) {
      const klass = require('./Element');
  ...
  get _precision() {
    if (!isPresent(this[_values]._precision)) {
      const klass = require('./Element');
  ...
  get _recall() {
    if (!isPresent(this[_values]._recall)) {
      const klass = require('./Element');
  ...
  get _fScore() {
    if (!isPresent(this[_values]._fScore)) {
      const klass = require('./Element');
