...
class Consent extends DomainResource {
  ...
  get actor() {
    if (!isPresent(this[_values].actor)) {
      const klass = require('./ConsentActor');
  ...
  get policy() {
    if (!isPresent(this[_values].policy)) {
      const klass = require('./ConsentPolicy');
  ...
  get data() {
    if (!isPresent(this[_values].data)) {
      const klass = require('./ConsentData');
  ...
  get except() {
    if (!isPresent(this[_values].except)) {
      const klass = require('./ConsentExcept');
