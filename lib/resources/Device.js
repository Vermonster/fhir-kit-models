...
class Device extends DomainResource {
  ...
  get _manufacturer() {
    if (!isPresent(this[_values]._manufacturer)) {
      const klass = require('./Element');
  ...
  get _manufactureDate() {
    if (!isPresent(this[_values]._manufactureDate)) {
      const klass = require('./Element');
  ...
  get _model() {
    if (!isPresent(this[_values]._model)) {
      const klass = require('./Element');
  ...
  get safety() {
    if (!isPresent(this[_values].safety)) {
      const klass = require('./CodeableConcept');
