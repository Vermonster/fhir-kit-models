...
class ImagingManifestSeries extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ImagingManifestSeries || values instanceof BackboneElement) {
  ...
  get instance() {
    if (!isPresent(this[_values].instance)) {
      const klass = require('./ImagingManifestInstance');
...
module.exports = ImagingManifestSeries;
