...
class ClaimResponse extends DomainResource {
  constructor(values = {}) {
    ...
    if (values instanceof ClaimResponse ||
  ...
  get item() {
    if (!isPresent(this[_values].item)) {
      const klass = require('./ClaimResponseItem');
  ...
  get addItem() {
    if (!isPresent(this[_values].addItem)) {
      const klass = require('./ClaimResponseAddItem');
  ...
  get error() {
    if (!isPresent(this[_values].error)) {
      const klass = require('./ClaimResponseError');
  ...
  get payment() {
    if (!isPresent(this[_values].payment)) {
      const klass = require('./ClaimResponsePayment');
  ...
  get processNote() {
    if (!isPresent(this[_values].processNote)) {
      const klass = require('./ClaimResponseProcessNote');
  ...
  get insurance() {
    if (!isPresent(this[_values].insurance)) {
      const klass = require('./ClaimResponseInsurance');
