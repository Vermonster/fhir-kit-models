...
class TestScriptRule3 extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof TestScriptRule3 || values instanceof BackboneElement) {
  ...
  get param() {
    if (!isPresent(this[_values].param)) {
      const klass = require('./TestScriptParam3');
...
module.exports = TestScriptRule3;
