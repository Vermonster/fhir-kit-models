...
class CapabilityStatementRest extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof CapabilityStatementRest || values instanceof BackboneElement) {
  ...
  get security() {
    if (!isPresent(this[_values].security)) {
      const klass = require('./CapabilityStatementSecurity');
  ...
  get resource() {
    if (!isPresent(this[_values].resource)) {
      const klass = require('./CapabilityStatementResource');
  ...
  get interaction() {
    if (!isPresent(this[_values].interaction)) {
      const klass = require('./CapabilityStatementInteraction1');
  ...
  get operation() {
    if (!isPresent(this[_values].operation)) {
      const klass = require('./CapabilityStatementOperation');
