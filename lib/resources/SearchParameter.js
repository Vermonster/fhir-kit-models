...
class SearchParameter extends DomainResource {
  constructor(values = {}) {
    ...
    if (values instanceof SearchParameter ||
  ...
  get _derivedFrom() {
    if (!isPresent(this[_values]._derivedFrom)) {
      const klass = require('./Element');
  ...
  get _xpathUsage() {
    if (!isPresent(this[_values]._xpathUsage)) {
      const klass = require('./Element');
  ...
  get _modifier() {
    if (!isPresent(this[_values]._modifier)) {
      const klass = require('./Element');
  ...
  get _chain() {
    if (!isPresent(this[_values]._chain)) {
      const klass = require('./Element');
  ...
  get component() {
    if (!isPresent(this[_values].component)) {
      const klass = require('./SearchParameterComponent');
