...
class ExpansionProfile extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ExpansionProfile ||
  ...
  get fixedVersion() {
    if (!isPresent(this[_values].fixedVersion)) {
      const klass = require('./ExpansionProfileFixedVersion');
  ...
  get excludedSystem() {
    if (!isPresent(this[_values].excludedSystem)) {
      const klass = require('./ExpansionProfileExcludedSystem');
  ...
  get designation() {
    if (!isPresent(this[_values].designation)) {
      const klass = require('./ExpansionProfileDesignation');
