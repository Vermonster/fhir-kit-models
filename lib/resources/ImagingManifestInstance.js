...
class ImagingManifestInstance extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ImagingManifestInstance || values instanceof BackboneElement) {
...
module.exports = ImagingManifestInstance;
