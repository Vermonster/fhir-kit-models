...
class Coverage extends DomainResource {
  ...
  get policyHolder() {
    if (!isPresent(this[_values].policyHolder)) {
  ...
  get subscriber() {
    if (!isPresent(this[_values].subscriber)) {
      const klass = require('./Reference');
  ...
  get _subscriberId() {
    if (!isPresent(this[_values]._subscriberId)) {
      const klass = require('./Element');
  ...
  get beneficiary() {
    if (!isPresent(this[_values].beneficiary)) {
      const klass = require('./Reference');
  ...
  get payor() {
    if (!isPresent(this[_values].payor)) {
      const klass = require('./Reference');
  ...
  get grouping() {
    if (!isPresent(this[_values].grouping)) {
      const klass = require('./CoverageGrouping');
  ...
  get _dependent() {
    if (!isPresent(this[_values]._dependent)) {
      const klass = require('./Element');
  ...
  get _order() {
    if (!isPresent(this[_values]._order)) {
      const klass = require('./Element');
  ...
  get _network() {
    if (!isPresent(this[_values]._network)) {
      const klass = require('./Element');
