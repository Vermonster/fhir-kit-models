...
class PlanDefinitionAction extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof PlanDefinitionAction || values instanceof BackboneElement) {
  ...
  get condition() {
    if (!isPresent(this[_values].condition)) {
      const klass = require('./PlanDefinitionCondition');
  ...
  get relatedAction() {
    if (!isPresent(this[_values].relatedAction)) {
      const klass = require('./PlanDefinitionRelatedAction');
  ...
  get participant() {
    if (!isPresent(this[_values].participant)) {
      const klass = require('./PlanDefinitionParticipant');
  ...
  get dynamicValue() {
    if (!isPresent(this[_values].dynamicValue)) {
      const klass = require('./PlanDefinitionDynamicValue');
  ...
  get action() {
    if (!isPresent(this[_values].action)) {
      const klass = require('./PlanDefinitionAction');
