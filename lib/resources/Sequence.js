...
class Sequence extends DomainResource {
  ...
  get _coordinateSystem() {
    if (!isPresent(this[_values]._coordinateSystem)) {
      const klass = require('./Element');
  ...
  get referenceSeq() {
    if (!isPresent(this[_values].referenceSeq)) {
      const klass = require('./SequenceReferenceSeq');
  ...
  get variant() {
    if (!isPresent(this[_values].variant)) {
      const klass = require('./SequenceVariant');
  ...
  get _observedSeq() {
    if (!isPresent(this[_values]._observedSeq)) {
      const klass = require('./Element');
  ...
  get quality() {
    if (!isPresent(this[_values].quality)) {
      const klass = require('./SequenceQuality');
  ...
  get _readCoverage() {
    if (!isPresent(this[_values]._readCoverage)) {
      const klass = require('./Element');
  ...
  get repository() {
    if (!isPresent(this[_values].repository)) {
      const klass = require('./SequenceRepository');
  ...
  get pointer() {
    if (!isPresent(this[_values].pointer)) {
      const klass = require('./Reference');
