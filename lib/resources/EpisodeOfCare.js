...
class EpisodeOfCare extends DomainResource {
  constructor(values = {}) {
    ...
    if (values instanceof EpisodeOfCare ||
  ...
  get statusHistory() {
    if (!isPresent(this[_values].statusHistory)) {
      const klass = require('./EpisodeOfCareStatusHistory');
  ...
  get diagnosis() {
    if (!isPresent(this[_values].diagnosis)) {
      const klass = require('./EpisodeOfCareDiagnosis');
  ...
  get referralRequest() {
    if (!isPresent(this[_values].referralRequest)) {
      const klass = require('./Reference');
  ...
  get careManager() {
    if (!isPresent(this[_values].careManager)) {
      const klass = require('./Reference');
  ...
  get team() {
    if (!isPresent(this[_values].team)) {
      const klass = require('./Reference');
