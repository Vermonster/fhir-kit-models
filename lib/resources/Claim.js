...
class Claim extends DomainResource {
  ...
  get related() {
    if (!isPresent(this[_values].related)) {
      const klass = require('./ClaimRelated');
  ...
  get payee() {
    if (!isPresent(this[_values].payee)) {
      const klass = require('./ClaimPayee');
  ...
  get careTeam() {
    if (!isPresent(this[_values].careTeam)) {
      const klass = require('./ClaimCareTeam');
  ...
  get information() {
    if (!isPresent(this[_values].information)) {
      const klass = require('./ClaimInformation');
  ...
  get diagnosis() {
    if (!isPresent(this[_values].diagnosis)) {
      const klass = require('./ClaimDiagnosis');
  ...
  get procedure() {
    if (!isPresent(this[_values].procedure)) {
      const klass = require('./ClaimProcedure');
  ...
  get insurance() {
    if (!isPresent(this[_values].insurance)) {
      const klass = require('./ClaimInsurance');
  ...
  get accident() {
    if (!isPresent(this[_values].accident)) {
      const klass = require('./ClaimAccident');
