...
class ExplanationOfBenefit extends DomainResource {
  constructor(values = {}) {
    ...
    if (values instanceof ExplanationOfBenefit ||
  ...
  get related() {
    if (!isPresent(this[_values].related)) {
      const klass = require('./ExplanationOfBenefitRelated');
  ...
  get payee() {
    if (!isPresent(this[_values].payee)) {
      const klass = require('./ExplanationOfBenefitPayee');
  ...
  get information() {
    if (!isPresent(this[_values].information)) {
      const klass = require('./ExplanationOfBenefitInformation');
  ...
  get careTeam() {
    if (!isPresent(this[_values].careTeam)) {
      const klass = require('./ExplanationOfBenefitCareTeam');
  ...
  get diagnosis() {
    if (!isPresent(this[_values].diagnosis)) {
      const klass = require('./ExplanationOfBenefitDiagnosis');
  ...
  get procedure() {
    if (!isPresent(this[_values].procedure)) {
      const klass = require('./ExplanationOfBenefitProcedure');
  ...
  get insurance() {
    if (!isPresent(this[_values].insurance)) {
      const klass = require('./ExplanationOfBenefitInsurance');
  ...
  get accident() {
    if (!isPresent(this[_values].accident)) {
      const klass = require('./ExplanationOfBenefitAccident');
  ...
  get item() {
    if (!isPresent(this[_values].item)) {
      const klass = require('./ExplanationOfBenefitItem');
  ...
  get addItem() {
    if (!isPresent(this[_values].addItem)) {
      const klass = require('./ExplanationOfBenefitAddItem');
  ...
  get payment() {
    if (!isPresent(this[_values].payment)) {
      const klass = require('./ExplanationOfBenefitPayment');
  ...
  get processNote() {
    if (!isPresent(this[_values].processNote)) {
      const klass = require('./ExplanationOfBenefitProcessNote');
  ...
  get benefitBalance() {
    if (!isPresent(this[_values].benefitBalance)) {
      const klass = require('./ExplanationOfBenefitBenefitBalance');
