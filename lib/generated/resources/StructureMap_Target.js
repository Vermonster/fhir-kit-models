...
class StructureMap_Target extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof StructureMap_Target || values instanceof BackboneElement) {
  ...
  get parameter() {
    if (!this[_values].parameter) {
      const klass = require('./StructureMap_Parameter');
