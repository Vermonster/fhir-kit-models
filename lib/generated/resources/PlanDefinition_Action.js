...
class PlanDefinition_Action extends BackboneElement {
  ...
  get _textEquivalent() {
    if (!this[_values]._textEquivalent) {
      const klass = require('./Element');
  ...
  get triggerDefinition() {
    if (!this[_values].triggerDefinition) {
  ...
  get timingDuration() {
    if (!this[_values].timingDuration) {
  ...
  get _groupingBehavior() {
    if (!this[_values]._groupingBehavior) {
      const klass = require('./Element');
  ...
  get _selectionBehavior() {
    if (!this[_values]._selectionBehavior) {
      const klass = require('./Element');
  ...
  get _requiredBehavior() {
    if (!this[_values]._requiredBehavior) {
      const klass = require('./Element');
  ...
  get _precheckBehavior() {
    if (!this[_values]._precheckBehavior) {
      const klass = require('./Element');
  ...
  get _cardinalityBehavior() {
    if (!this[_values]._cardinalityBehavior) {
      const klass = require('./Element');
