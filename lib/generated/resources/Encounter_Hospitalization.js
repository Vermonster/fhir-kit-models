...
class Encounter_Hospitalization extends BackboneElement {
  ...
  get preAdmissionIdentifier() {
    if (!this[_values].preAdmissionIdentifier) {
  ...
  get dietPreference() {
    if (!this[_values].dietPreference) {
      const klass = require('./CodeableConcept');
  ...
  get specialCourtesy() {
    if (!this[_values].specialCourtesy) {
      const klass = require('./CodeableConcept');
  ...
  get specialArrangement() {
    if (!this[_values].specialArrangement) {
      const klass = require('./CodeableConcept');
  ...
  get dischargeDisposition() {
    if (!this[_values].dischargeDisposition) {
      const klass = require('./CodeableConcept');
