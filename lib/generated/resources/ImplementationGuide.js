...
class ImplementationGuide extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ImplementationGuide || values instanceof DomainResource) {
  ...
  get dependency() {
    if (!this[_values].dependency) {
      const klass = require('./ImplementationGuide_Dependency');
  ...
  get package() {
    if (!this[_values].package) {
      const klass = require('./ImplementationGuide_Package');
  ...
  get global() {
    if (!this[_values].global) {
      const klass = require('./ImplementationGuide_Global');
  ...
  get page() {
    if (!this[_values].page) {
      const klass = require('./ImplementationGuide_Page');
