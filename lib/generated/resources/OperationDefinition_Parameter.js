...
class OperationDefinition_Parameter extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof OperationDefinition_Parameter || values instanceof BackboneElement) {
  ...
  get binding() {
    if (!this[_values].binding) {
      const klass = require('./OperationDefinition_Binding');
