...
class ConceptMap extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ConceptMap || values instanceof DomainResource) {
  ...
  get sourceReference() {
    if (!this[_values].sourceReference) {
  ...
  get targetUri() {
    return this[_values].targetUri;
  }
  set targetUri(value) {
    return this[_values].targetUri = value;
  }
  get _targetUri() {
    if (!this[_values]._targetUri) {
      const klass = require('./Element');
      this[_values]._targetUri = new klass();
    }
    return this[_values]._targetUri;
  }
  set _targetUri(value) {
    const klass = require('./Element');
    return this[_values]._targetUri = new klass(value);
  }
  get targetReference() {
    if (!this[_values].targetReference) {
      const klass = require('./Reference');
  ...
  get group() {
    if (!this[_values].group) {
      const klass = require('./ConceptMap_Group');
