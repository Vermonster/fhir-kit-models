...
class ExplanationOfBenefit_Diagnosis extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ExplanationOfBenefit_Diagnosis || values instanceof BackboneElement) {
  ...
  get diagnosisCodeableConcept() {
    if (!this[_values].diagnosisCodeableConcept) {
  ...
  get diagnosisReference() {
    if (!this[_values].diagnosisReference) {
