...
class ActivityDefinition extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ActivityDefinition || values instanceof DomainResource) {
  ...
  get participant() {
    if (!this[_values].participant) {
      const klass = require('./ActivityDefinition_Participant');
  ...
  get productReference() {
    if (!this[_values].productReference) {
      const klass = require('./Reference');
  ...
  get productCodeableConcept() {
    if (!this[_values].productCodeableConcept) {
      const klass = require('./CodeableConcept');
  ...
  get dynamicValue() {
    if (!this[_values].dynamicValue) {
      const klass = require('./ActivityDefinition_DynamicValue');
