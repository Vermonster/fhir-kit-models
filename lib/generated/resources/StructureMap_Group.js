...
class StructureMap_Group extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof StructureMap_Group || values instanceof BackboneElement) {
  ...
  get input() {
    if (!this[_values].input) {
      const klass = require('./StructureMap_Input');
