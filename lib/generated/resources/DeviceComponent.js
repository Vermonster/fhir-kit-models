...
class DeviceComponent extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof DeviceComponent || values instanceof DomainResource) {
  ...
  get _lastSystemChange() {
    if (!this[_values]._lastSystemChange) {
  ...
  get parameterGroup() {
    if (!this[_values].parameterGroup) {
      const klass = require('./CodeableConcept');
  ...
  get _measurementPrinciple() {
    if (!this[_values]._measurementPrinciple) {
      const klass = require('./Element');
  ...
  get productionSpecification() {
    if (!this[_values].productionSpecification) {
      const klass = require('./DeviceComponent_ProductionSpecification');
