...
class ExplanationOfBenefit_BenefitBalance extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ExplanationOfBenefit_BenefitBalance || values instanceof BackboneElement) {
  ...
  get financial() {
    if (!this[_values].financial) {
      const klass = require('./ExplanationOfBenefit_Financial');
