...
class Condition extends DomainResource {
  ...
  get _clinicalStatus() {
    if (!this[_values]._clinicalStatus) {
  ...
  get _verificationStatus() {
    if (!this[_values]._verificationStatus) {
      const klass = require('./Element');
  ...
  get _onsetDateTime() {
    if (!this[_values]._onsetDateTime) {
      const klass = require('./Element');
  ...
  get _abatementDateTime() {
    if (!this[_values]._abatementDateTime) {
      const klass = require('./Element');
  ...
  get _abatementBoolean() {
    if (!this[_values]._abatementBoolean) {
      const klass = require('./Element');
  ...
  get abatementPeriod() {
    if (!this[_values].abatementPeriod) {
      const klass = require('./Period');
  ...
  get abatementRange() {
    if (!this[_values].abatementRange) {
      const klass = require('./Range');
  ...
  get _abatementString() {
    if (!this[_values]._abatementString) {
      const klass = require('./Element');
