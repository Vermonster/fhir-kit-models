...
class Immunization extends DomainResource {
  ...
  get _primarySource() {
    if (!this[_values]._primarySource) {
      const klass = require('./Element');
  ...
  get practitioner() {
    if (!this[_values].practitioner) {
      const klass = require('./Immunization_Practitioner');
  ...
  get explanation() {
    if (!this[_values].explanation) {
      const klass = require('./Immunization_Explanation');
  ...
  get reaction() {
    if (!this[_values].reaction) {
      const klass = require('./Immunization_Reaction');
  ...
  get vaccinationProtocol() {
    if (!this[_values].vaccinationProtocol) {
      const klass = require('./Immunization_VaccinationProtocol');
