...
class ExplanationOfBenefit_Item extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ExplanationOfBenefit_Item || values instanceof BackboneElement) {
  ...
  get _careTeamLinkId() {
    if (!this[_values]._careTeamLinkId) {
      const klass = require('./Element');
  ...
  get _diagnosisLinkId() {
    if (!this[_values]._diagnosisLinkId) {
      const klass = require('./Element');
  ...
  get _procedureLinkId() {
    if (!this[_values]._procedureLinkId) {
      const klass = require('./Element');
  ...
  get _informationLinkId() {
    if (!this[_values]._informationLinkId) {
      const klass = require('./Element');
  ...
  get servicedPeriod() {
    if (!this[_values].servicedPeriod) {
  ...
  get locationCodeableConcept() {
    if (!this[_values].locationCodeableConcept) {
      const klass = require('./CodeableConcept');
  ...
  get locationAddress() {
    if (!this[_values].locationAddress) {
  ...
  get locationReference() {
    if (!this[_values].locationReference) {
  ...
  get detail() {
    if (!this[_values].detail) {
      const klass = require('./ExplanationOfBenefit_Detail');
