...
class TestReport extends DomainResource {
  ...
  get participant() {
    if (!this[_values].participant) {
      const klass = require('./TestReport_Participant');
  ...
  get setup() {
    if (!this[_values].setup) {
      const klass = require('./TestReport_Setup');
  ...
  get test() {
    if (!this[_values].test) {
      const klass = require('./TestReport_Test');
  ...
  get teardown() {
    if (!this[_values].teardown) {
      const klass = require('./TestReport_Teardown');
