...
class ClaimResponse extends DomainResource {
  ...
  get requestProvider() {
    if (!this[_values].requestProvider) {
      const klass = require('./Reference');
  ...
  get requestOrganization() {
    if (!this[_values].requestOrganization) {
      const klass = require('./Reference');
  ...
  get communicationRequest() {
    if (!this[_values].communicationRequest) {
      const klass = require('./Reference');
