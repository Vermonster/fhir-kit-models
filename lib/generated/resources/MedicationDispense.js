...
class MedicationDispense extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof MedicationDispense || values instanceof DomainResource) {
  ...
  get performer() {
    if (!this[_values].performer) {
      const klass = require('./MedicationDispense_Performer');
  ...
  get authorizingPrescription() {
    if (!this[_values].authorizingPrescription) {
      const klass = require('./Reference');
  ...
  get _whenHandedOver() {
    if (!this[_values]._whenHandedOver) {
      const klass = require('./Element');
  ...
  get substitution() {
    if (!this[_values].substitution) {
      const klass = require('./MedicationDispense_Substitution');
  ...
  get notDoneReasonCodeableConcept() {
    if (!this[_values].notDoneReasonCodeableConcept) {
      const klass = require('./CodeableConcept');
  ...
  get notDoneReasonReference() {
    if (!this[_values].notDoneReasonReference) {
      const klass = require('./Reference');
