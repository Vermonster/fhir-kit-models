...
class FamilyMemberHistory extends DomainResource {
  ...
  get _deceasedString() {
    if (!this[_values]._deceasedString) {
      const klass = require('./Element');
