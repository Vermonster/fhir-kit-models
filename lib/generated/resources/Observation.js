...
class Observation extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Observation || values instanceof DomainResource) {
  ...
  get dataAbsentReason() {
    if (!this[_values].dataAbsentReason) {
      const klass = require('./CodeableConcept');
  ...
  get interpretation() {
    if (!this[_values].interpretation) {
      const klass = require('./CodeableConcept');
  ...
  get referenceRange() {
    if (!this[_values].referenceRange) {
  ...
  get related() {
    if (!this[_values].related) {
      const klass = require('./Observation_Related');
  ...
  get component() {
    if (!this[_values].component) {
      const klass = require('./Observation_Component');
