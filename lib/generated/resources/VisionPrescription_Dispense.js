...
class VisionPrescription_Dispense extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof VisionPrescription_Dispense || values instanceof BackboneElement) {
