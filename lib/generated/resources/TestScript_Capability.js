...
class TestScript_Capability extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof TestScript_Capability || values instanceof BackboneElement) {
