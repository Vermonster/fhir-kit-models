...
class ExpansionProfile extends DomainResource {
  ...
  get excludedSystem() {
    if (!this[_values].excludedSystem) {
  ...
  get _includeDesignations() {
    if (!this[_values]._includeDesignations) {
      const klass = require('./Element');
  ...
  get _includeDefinition() {
    if (!this[_values]._includeDefinition) {
      const klass = require('./Element');
  ...
  get _excludeNested() {
    if (!this[_values]._excludeNested) {
      const klass = require('./Element');
  ...
  get _excludeNotForUI() {
    if (!this[_values]._excludeNotForUI) {
      const klass = require('./Element');
  ...
  get _excludePostCoordinated() {
    if (!this[_values]._excludePostCoordinated) {
      const klass = require('./Element');
  ...
  get _displayLanguage() {
    if (!this[_values]._displayLanguage) {
      const klass = require('./Element');
  ...
  get _limitedExpansion() {
    if (!this[_values]._limitedExpansion) {
      const klass = require('./Element');
