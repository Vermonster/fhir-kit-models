...
class TestScript_Assert extends BackboneElement {
  ...
  get _compareToSourceId() {
    if (!this[_values]._compareToSourceId) {
      const klass = require('./Element');
  ...
  get _compareToSourceExpression() {
    if (!this[_values]._compareToSourceExpression) {
      const klass = require('./Element');
  ...
  get _compareToSourcePath() {
    if (!this[_values]._compareToSourcePath) {
      const klass = require('./Element');
  ...
  get _navigationLinks() {
    if (!this[_values]._navigationLinks) {
      const klass = require('./Element');
  ...
  get _requestMethod() {
    if (!this[_values]._requestMethod) {
      const klass = require('./Element');
  ...
  get _validateProfileId() {
    if (!this[_values]._validateProfileId) {
      const klass = require('./Element');
