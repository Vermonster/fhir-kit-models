...
class PaymentReconciliation extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof PaymentReconciliation || values instanceof DomainResource) {
  ...
  get detail() {
    if (!this[_values].detail) {
      const klass = require('./PaymentReconciliation_Detail');
  ...
  get processNote() {
    if (!this[_values].processNote) {
      const klass = require('./PaymentReconciliation_ProcessNote');
