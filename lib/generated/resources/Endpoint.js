...
class Endpoint extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Endpoint || values instanceof DomainResource) {
  ...
  get connectionType() {
    if (!this[_values].connectionType) {
  ...
  get _payloadMimeType() {
    if (!this[_values]._payloadMimeType) {
      const klass = require('./Element');
