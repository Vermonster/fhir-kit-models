...
class Questionnaire_Item extends BackboneElement {
  ...
  get _initialBoolean() {
    if (!this[_values]._initialBoolean) {
      const klass = require('./Element');
  ...
  get _initialDecimal() {
    if (!this[_values]._initialDecimal) {
      const klass = require('./Element');
  ...
  get _initialInteger() {
    if (!this[_values]._initialInteger) {
      const klass = require('./Element');
  ...
  get _initialDateTime() {
    if (!this[_values]._initialDateTime) {
      const klass = require('./Element');
  ...
  get _initialString() {
    if (!this[_values]._initialString) {
      const klass = require('./Element');
  ...
  get initialAttachment() {
    if (!this[_values].initialAttachment) {
  ...
  get initialQuantity() {
    if (!this[_values].initialQuantity) {
  ...
  get initialReference() {
    if (!this[_values].initialReference) {
      const klass = require('./Reference');
