...
class OperationOutcome_Issue extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof OperationOutcome_Issue || values instanceof BackboneElement) {
