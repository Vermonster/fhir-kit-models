...
class ClinicalImpression_Finding extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ClinicalImpression_Finding || values instanceof BackboneElement) {
  ...
  get itemCodeableConcept() {
    if (!this[_values].itemCodeableConcept) {
