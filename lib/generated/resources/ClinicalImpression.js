...
class ClinicalImpression extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ClinicalImpression || values instanceof DomainResource) {
  ...
  get _effectiveDateTime() {
    if (!this[_values]._effectiveDateTime) {
      const klass = require('./Element');
  ...
  get investigation() {
    if (!this[_values].investigation) {
      const klass = require('./ClinicalImpression_Investigation');
  ...
  get finding() {
    if (!this[_values].finding) {
      const klass = require('./ClinicalImpression_Finding');
  ...
  get prognosisCodeableConcept() {
    if (!this[_values].prognosisCodeableConcept) {
      const klass = require('./CodeableConcept');
  ...
  get prognosisReference() {
    if (!this[_values].prognosisReference) {
      const klass = require('./Reference');
