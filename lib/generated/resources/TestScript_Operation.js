...
class TestScript_Operation extends BackboneElement {
  ...
  get _encodeRequestUrl() {
    if (!this[_values]._encodeRequestUrl) {
      const klass = require('./Element');
