...
class Specimen extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Specimen || values instanceof DomainResource) {
  ...
  get accessionIdentifier() {
    if (!this[_values].accessionIdentifier) {
      const klass = require('./Identifier');
  ...
  get collection() {
    if (!this[_values].collection) {
      const klass = require('./Specimen_Collection');
  ...
  get processing() {
    if (!this[_values].processing) {
      const klass = require('./Specimen_Processing');
  ...
  get container() {
    if (!this[_values].container) {
      const klass = require('./Specimen_Container');
