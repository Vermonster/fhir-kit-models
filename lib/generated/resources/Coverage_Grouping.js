...
class Coverage_Grouping extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Coverage_Grouping || values instanceof BackboneElement) {
  ...
  get _subGroupDisplay() {
    if (!this[_values]._subGroupDisplay) {
      const klass = require('./Element');
  ...
  get _subPlanDisplay() {
    if (!this[_values]._subPlanDisplay) {
      const klass = require('./Element');
  ...
  get _subClassDisplay() {
    if (!this[_values]._subClassDisplay) {
      const klass = require('./Element');
