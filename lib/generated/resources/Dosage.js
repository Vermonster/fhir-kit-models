...
class Dosage extends Element {
  ...
  get additionalInstruction() {
    if (!this[_values].additionalInstruction) {
  ...
  get _patientInstruction() {
    if (!this[_values]._patientInstruction) {
      const klass = require('./Element');
  ...
  get _asNeededBoolean() {
    if (!this[_values]._asNeededBoolean) {
      const klass = require('./Element');
  ...
  get asNeededCodeableConcept() {
    if (!this[_values].asNeededCodeableConcept) {
      const klass = require('./CodeableConcept');
  ...
  get doseSimpleQuantity() {
    if (!this[_values].doseSimpleQuantity) {
  ...
  get maxDosePerPeriod() {
    if (!this[_values].maxDosePerPeriod) {
  ...
  get maxDosePerAdministration() {
    if (!this[_values].maxDosePerAdministration) {
      const klass = require('./Quantity');
  ...
  get maxDosePerLifetime() {
    if (!this[_values].maxDosePerLifetime) {
      const klass = require('./Quantity');
  ...
  get rateSimpleQuantity() {
    if (!this[_values].rateSimpleQuantity) {
      const klass = require('./Quantity');
