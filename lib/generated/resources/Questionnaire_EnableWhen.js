...
class Questionnaire_EnableWhen extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Questionnaire_EnableWhen || values instanceof BackboneElement) {
  ...
  get _answerBoolean() {
    if (!this[_values]._answerBoolean) {
      const klass = require('./Element');
  ...
  get _answerDecimal() {
    if (!this[_values]._answerDecimal) {
      const klass = require('./Element');
  ...
  get _answerInteger() {
    if (!this[_values]._answerInteger) {
      const klass = require('./Element');
  ...
  get _answerDateTime() {
    if (!this[_values]._answerDateTime) {
      const klass = require('./Element');
  ...
  get answerAttachment() {
    if (!this[_values].answerAttachment) {
  ...
  get answerQuantity() {
    if (!this[_values].answerQuantity) {
  ...
  get answerReference() {
    if (!this[_values].answerReference) {
