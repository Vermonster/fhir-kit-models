...
class CapabilityStatement extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof CapabilityStatement || values instanceof DomainResource) {
  ...
  get software() {
    if (!this[_values].software) {
      const klass = require('./CapabilityStatement_Software');
  ...
  get implementation() {
    if (!this[_values].implementation) {
      const klass = require('./CapabilityStatement_Implementation');
  ...
  get _acceptUnknown() {
    if (!this[_values]._acceptUnknown) {
      const klass = require('./Element');
  ...
  get _implementationGuide() {
    if (!this[_values]._implementationGuide) {
      const klass = require('./Element');
  ...
  get rest() {
    if (!this[_values].rest) {
      const klass = require('./CapabilityStatement_Rest');
  ...
  get messaging() {
    if (!this[_values].messaging) {
      const klass = require('./CapabilityStatement_Messaging');
  ...
  get document() {
    if (!this[_values].document) {
      const klass = require('./CapabilityStatement_Document');
