...
class EligibilityResponse_Financial extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof EligibilityResponse_Financial || values instanceof BackboneElement) {
  ...
  get _allowedUnsignedInt() {
    if (!this[_values]._allowedUnsignedInt) {
  ...
  get _allowedString() {
    if (!this[_values]._allowedString) {
      const klass = require('./Element');
  ...
  get _usedUnsignedInt() {
    if (!this[_values]._usedUnsignedInt) {
      const klass = require('./Element');
