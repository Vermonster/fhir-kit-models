...
class PlanDefinition_Target extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof PlanDefinition_Target || values instanceof BackboneElement) {
  ...
  get detailQuantity() {
    if (!this[_values].detailQuantity) {
  ...
  get detailCodeableConcept() {
    if (!this[_values].detailCodeableConcept) {
      const klass = require('./CodeableConcept');
