...
class ElementDefinition_Slicing extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ElementDefinition_Slicing || values instanceof BackboneElement) {
  ...
  get discriminator() {
    if (!this[_values].discriminator) {
      const klass = require('./ElementDefinition_Discriminator');
