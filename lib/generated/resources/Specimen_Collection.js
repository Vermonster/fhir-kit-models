...
class Specimen_Collection extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Specimen_Collection || values instanceof BackboneElement) {
  ...
  get _collectedDateTime() {
    if (!this[_values]._collectedDateTime) {
  ...
  get collectedPeriod() {
    if (!this[_values].collectedPeriod) {
