...
class Patient extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Patient || values instanceof DomainResource) {
  ...
  get _deceasedBoolean() {
    if (!this[_values]._deceasedBoolean) {
      const klass = require('./Element');
  ...
  get _deceasedDateTime() {
    if (!this[_values]._deceasedDateTime) {
      const klass = require('./Element');
  ...
  get _multipleBirthBoolean() {
    if (!this[_values]._multipleBirthBoolean) {
      const klass = require('./Element');
  ...
  get _multipleBirthInteger() {
    if (!this[_values]._multipleBirthInteger) {
      const klass = require('./Element');
  ...
  get contact() {
    if (!this[_values].contact) {
      const klass = require('./Patient_Contact');
  ...
  get animal() {
    if (!this[_values].animal) {
      const klass = require('./Patient_Animal');
  ...
  get communication() {
    if (!this[_values].communication) {
      const klass = require('./Patient_Communication');
  ...
  get generalPractitioner() {
    if (!this[_values].generalPractitioner) {
  ...
  get link() {
    if (!this[_values].link) {
      const klass = require('./Patient_Link');
