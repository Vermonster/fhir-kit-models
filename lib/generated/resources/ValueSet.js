...
class ValueSet extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ValueSet || values instanceof DomainResource) {
  ...
  get immutable() {
    return this[_values].immutable;
  }
  set immutable(value) {
    return this[_values].immutable = value;
  }
  get _immutable() {
    if (!this[_values]._immutable) {
      const klass = require('./Element');
      this[_values]._immutable = new klass();
    }
    return this[_values]._immutable;
  }
  set _immutable(value) {
    const klass = require('./Element');
    return this[_values]._immutable = new klass(value);
  }
  get purpose() {
  ...
  get extensible() {
    return this[_values].extensible;
  }
  set extensible(value) {
    return this[_values].extensible = value;
  }
  get _extensible() {
    if (!this[_values]._extensible) {
      const klass = require('./Element');
      this[_values]._extensible = new klass();
    }
    return this[_values]._extensible;
  }
  set _extensible(value) {
    const klass = require('./Element');
    return this[_values]._extensible = new klass(value);
  }
  get compose() {
    if (!this[_values].compose) {
      const klass = require('./ValueSet_Compose');
      this[_values].compose = new klass();
    }
    return this[_values].compose;
  }
  set compose(value) {
    const klass = require('./ValueSet_Compose');
    return this[_values].compose = new klass(value);
  }
  get expansion() {
    if (!this[_values].expansion) {
      const klass = require('./ValueSet_Expansion');
      this[_values].expansion = new klass();
    }
    return this[_values].expansion;
  }
  set expansion(value) {
    const klass = require('./ValueSet_Expansion');
    return this[_values].expansion = new klass(value);
  }
}
