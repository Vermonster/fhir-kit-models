...
class NutritionOrder extends DomainResource {
  ...
  get allergyIntolerance() {
    if (!this[_values].allergyIntolerance) {
      const klass = require('./Reference');
  ...
  get foodPreferenceModifier() {
    if (!this[_values].foodPreferenceModifier) {
  ...
  get excludeFoodModifier() {
    if (!this[_values].excludeFoodModifier) {
      const klass = require('./CodeableConcept');
  ...
  get enteralFormula() {
    if (!this[_values].enteralFormula) {
