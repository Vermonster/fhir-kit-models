...
class StructureDefinition extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof StructureDefinition || values instanceof DomainResource) {
  ...
  get mapping() {
    if (!this[_values].mapping) {
      const klass = require('./StructureDefinition_Mapping');
  ...
  get _contextInvariant() {
    if (!this[_values]._contextInvariant) {
      const klass = require('./Element');
  ...
  get _baseDefinition() {
    if (!this[_values]._baseDefinition) {
      const klass = require('./Element');
  ...
  get snapshot() {
    if (!this[_values].snapshot) {
      const klass = require('./StructureDefinition_Snapshot');
  ...
  get differential() {
    if (!this[_values].differential) {
      const klass = require('./StructureDefinition_Differential');
