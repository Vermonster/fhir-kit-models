...
class Contract_ValuedItem extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Contract_ValuedItem || values instanceof BackboneElement) {
  ...
  get entityCodeableConcept() {
    if (!this[_values].entityCodeableConcept) {
  ...
  get entityReference() {
    if (!this[_values].entityReference) {
  ...
  get _effectiveTime() {
    if (!this[_values]._effectiveTime) {
