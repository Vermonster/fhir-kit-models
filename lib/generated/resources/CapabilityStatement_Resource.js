...
class CapabilityStatement_Resource extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof CapabilityStatement_Resource || values instanceof BackboneElement) {
  ...
  get interaction() {
    if (!this[_values].interaction) {
      const klass = require('./CapabilityStatement_Interaction');
  ...
  get _conditionalCreate() {
    if (!this[_values]._conditionalCreate) {
      const klass = require('./Element');
  ...
  get _conditionalRead() {
    if (!this[_values]._conditionalRead) {
      const klass = require('./Element');
  ...
  get _conditionalUpdate() {
    if (!this[_values]._conditionalUpdate) {
      const klass = require('./Element');
  ...
  get _conditionalDelete() {
    if (!this[_values]._conditionalDelete) {
      const klass = require('./Element');
  ...
  get _referencePolicy() {
    if (!this[_values]._referencePolicy) {
      const klass = require('./Element');
  ...
  get _searchInclude() {
    if (!this[_values]._searchInclude) {
      const klass = require('./Element');
  ...
  get _searchRevInclude() {
    if (!this[_values]._searchRevInclude) {
      const klass = require('./Element');
