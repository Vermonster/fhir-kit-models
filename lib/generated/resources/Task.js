...
class Task extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof Task || values instanceof DomainResource) {
  ...
  get _definitionUri() {
    if (!this[_values]._definitionUri) {
  ...
  get definitionReference() {
    if (!this[_values].definitionReference) {
  ...
  get businessStatus() {
    if (!this[_values].businessStatus) {
      const klass = require('./CodeableConcept');
  ...
  get executionPeriod() {
    if (!this[_values].executionPeriod) {
  ...
  get requester() {
    if (!this[_values].requester) {
      const klass = require('./Task_Requester');
  ...
  get relevantHistory() {
    if (!this[_values].relevantHistory) {
      const klass = require('./Reference');
  ...
  get restriction() {
    if (!this[_values].restriction) {
      const klass = require('./Task_Restriction');
  ...
  get input() {
    if (!this[_values].input) {
      const klass = require('./Task_Input');
  ...
  get output() {
    if (!this[_values].output) {
      const klass = require('./Task_Output');
