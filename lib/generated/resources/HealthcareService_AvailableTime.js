...
class HealthcareService_AvailableTime extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof HealthcareService_AvailableTime || values instanceof BackboneElement) {
  ...
  get _availableStartTime() {
    if (!this[_values]._availableStartTime) {
      const klass = require('./Element');
  ...
  get _availableEndTime() {
    if (!this[_values]._availableEndTime) {
      const klass = require('./Element');
