...
class OperationDefinition_Binding extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof OperationDefinition_Binding || values instanceof BackboneElement) {
  ...
  get valueSetReference() {
    if (!this[_values].valueSetReference) {
