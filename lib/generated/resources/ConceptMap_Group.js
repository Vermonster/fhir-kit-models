...
class ConceptMap_Group extends BackboneElement {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof ConceptMap_Group || values instanceof BackboneElement) {
  ...
  get _sourceVersion() {
    if (!this[_values]._sourceVersion) {
      const klass = require('./Element');
  ...
  get _targetVersion() {
    if (!this[_values]._targetVersion) {
      const klass = require('./Element');
  ...
  get element() {
    if (!this[_values].element) {
      const klass = require('./ConceptMap_Element');
  ...
  get unmapped() {
    if (!this[_values].unmapped) {
      const klass = require('./ConceptMap_Unmapped');
