...
class EligibilityRequest extends DomainResource {
  constructor(values = {}) {
    super();
    this[_values] = {};
    if (values instanceof EligibilityRequest || values instanceof DomainResource) {
  ...
  get _businessArrangement() {
    if (!this[_values]._businessArrangement) {
      const klass = require('./Element');
  ...
  get benefitCategory() {
    if (!this[_values].benefitCategory) {
      const klass = require('./CodeableConcept');
  ...
  get benefitSubCategory() {
    if (!this[_values].benefitSubCategory) {
      const klass = require('./CodeableConcept');
